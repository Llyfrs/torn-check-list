...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        Dialog.resize(348, 636)
        Dialog.setMinimumSize(QtCore.QSize(181, 409))
        self.buttonBox = QtWidgets.QDialogButtonBox(Dialog)
        self.buttonBox.setGeometry(QtCore.QRect(200, 600, 131, 24))
        ...
        self.label_2.setGeometry(QtCore.QRect(0, 490, 151, 21))
        font = QtGui.QFont()
        font.setPointSize(11)
        self.label_2.setFont(font)
        self.label_2.setObjectName("label_2")
        self.line_2 = QtWidgets.QFrame(Dialog)
        self.line_2.setGeometry(QtCore.QRect(0, 510, 341, 16))
        self.line_2.setFrameShape(QtWidgets.QFrame.HLine)
        self.line_2.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.line_2.setObjectName("line_2")
        self.busts_number = QtWidgets.QSpinBox(Dialog)
        self.busts_number.setGeometry(QtCore.QRect(220, 530, 43, 24))
        self.busts_number.setMinimum(1)
        self.busts_number.setProperty("value", 3)
        self.busts_number.setObjectName("busts_number")
        self.label_3 = QtWidgets.QLabel(Dialog)
        self.label_3.setGeometry(QtCore.QRect(10, 530, 211, 21))
        ...
        self.addiction_amount.setGeometry(QtCore.QRect(220, 560, 43, 24))
        ...
        self.label_4.setGeometry(QtCore.QRect(10, 560, 211, 21))
